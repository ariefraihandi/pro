<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Project /</span> ariefraihandi.biz.id</h4>
                    ...
                    <div class="d-flex align-items-start align-items-sm-center gap-4 cent">
                        ...
                        <div class="button-wrapper">
                            <button type="button" class="btn btn-success">
                                <span class="d-none d-sm-block"></span>&nbsp; <?= $ins['name']; ?>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-5">
                <div class="col-md-6 col-lg-4 mb-3">
                    <div class="card h-100 ">
                        <div class="card-body ">
                            <h5 class="card-title cent">Icon</h5>
                            <div class="d-flex align-items-start align-items-sm-center gap-4 cent">
                                <img src="<?php echo base_url('vendor/arsha'); ?>/assets/img/<?= $ins['fav']; ?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                                <button type="button" class="btn btn-primary">
                                    <span class="tf-icons bx bx-check-square"></span>&nbsp; Change
                                </button>
                            </div>
                            <br>
                            <p class="text mb-0 cent"><?= $ins['name']; ?></p>
                            <p class="text mb-0 cent">(<?= $ins['alamat']; ?>)</p>
                        </div>
                    </div>
                </div>
