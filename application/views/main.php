					...
					<div class="card-body">
						...
						<div class="app-brand justify-content-center">
							<a href="<?= base_url('auth'); ?>" class="app-brand-link gap-2">
								...
								<span class="app-brand-text demo text-body fw-bolder">project</span>
							</a>
						</div>
						<!-- /Logo -->
						<?= $this->session->flashdata('message'); ?>
						<?= $this->session->flashdata('messageedit'); ?>
						<?= $this->session->flashdata('message_logror'); ?>
						<?= $this->session->flashdata('message_logout'); ?>
						<h4 class="mb-2">Selamat Datang Mas 👋</h4>
						<p class="mb-4">Silahkan Login Sayang</p>
						...
						<p class="text-center">
							<span>Apakah Anda Pegawai Baru?</span>
