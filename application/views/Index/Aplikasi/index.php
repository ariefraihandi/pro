...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('vendor/arsha/'); ?>assets/img/favicon.png" rel="icon">
  <link href="<?= base_url('vendor/arsha/'); ?>assets/img/apple-touch-icon.png" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Jost:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="<?= base_url('vendor/arsha/'); ?>assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="<?= base_url('vendor/arsha/'); ?>assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="<?= base_url('vendor/arsha/'); ?>assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="<?= base_url('vendor/arsha/'); ?>assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="<?= base_url('vendor/arsha/'); ?>assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
  <link href="<?= base_url('vendor/arsha/'); ?>assets/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="<?= base_url('vendor/arsha/'); ?>assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="<?= base_url('vendor/arsha/'); ?>assets/css/style.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top header-inner-pages">
    ...
    <h1 class="logo me-auto"><a href="index.html">AR Project</a></h1>
    ...
    <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#portfolio">Daftar Inovasi</a></li>
            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="<?= base_url('vendor/arsha/'); ?>assets/img/portfolio/portfolio-1.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('vendor/arsha/'); ?>assets/img/portfolio/portfolio-2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="<?= base_url('vendor/arsha/'); ?>assets/img/portfolio/portfolio-3.jpg" alt="">
                </div>
